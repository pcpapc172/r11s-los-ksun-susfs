...
#ifdef CONFIG_SEC_NFC_LOGGER_NXP
#ifdef CONFIG_SEC_NFC_LOGGER_ADD_ACPM_LOG_NXP
...
#else /* not IS_MODULE(CONFIG_NXP_NFC) */
static int __init nfc_i2c_dev_init(void)
{
	int ret = 0;
...
module_exit(nfc_i2c_dev_exit);
#endif /* IS_MODULE(CONFIG_NXP_NFC) */
